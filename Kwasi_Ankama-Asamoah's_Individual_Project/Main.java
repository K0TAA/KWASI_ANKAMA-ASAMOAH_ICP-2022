...
public class Main {
	...
	private static ArrayList<Airport> readAirportData() {
		...
		try {
			...
			while (scanner.hasNextLine()) {
				...
				Airport airport = new Airport(Integer.parseInt(tokens[0]), tokens[1], tokens[2], tokens[3], tokens[4],
						tokens[5],
	...
	private static ArrayList<Airline> readAirlineData() {
		...
		try {
			...
			while (scanner.hasNextLine()) {
				...
				Airline airline = new Airline(Integer.parseInt(tokens[0]), tokens[1], tokens[2], tokens[3], tokens[4],
						tokens[5],
						tokens[6], tokens[7]);
	...
	public static void main(String[] args) {
		...
		System.out.println("Your information has been generated and outputed into the 'test_output.txt' file");
	}
